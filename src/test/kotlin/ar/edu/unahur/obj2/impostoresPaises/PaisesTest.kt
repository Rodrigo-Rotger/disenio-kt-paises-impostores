...
class PaisesTest: DescribeSpec({
    ...
    describe("Creacion de Paises y Pruba"){
        ...
        it ("Probamos si son Plurinacionales"){
            ...
            Mexico.esPlurinacional().shouldBeFalse()
        }

        // Dejamos a Estados Unidos sin paises limitrofes para probar test de isla
        it("Probamos si son Isla"){
            EstadosUnidos.esIsla().shouldBeTrue()
